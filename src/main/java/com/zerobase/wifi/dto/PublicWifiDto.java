...
public class PublicWifiDto {
    ...
    private String wifiConnectionEnv;
    ...
    public String getWifiConnectionEnv() {
        return wifiConnectionEnv;
    }

    public void setWifiConnectionEnv(String wifiConnectionEnv) {
        this.wifiConnectionEnv = wifiConnectionEnv;
    }
